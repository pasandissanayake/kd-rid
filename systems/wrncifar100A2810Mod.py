...
class REDStudentNormalized(SystemModel):
    def __init__(self,
        ...
        self.model = WideResNet(depth=16, widen_factor=8, num_classes=num_classes, temperature=temperature)
...
class VIDStudent(SystemModel):
    def __init__(self, 
        ...
        self.model = WideResNet(depth=16, widen_factor=8, num_classes=num_classes, temperature=self.temp)

        self.filter1 = nn.Sequential(*[
            nn.Conv2d(128, 320, kernel_size=1, stride=1, padding=0, bias=False),
            nn.BatchNorm2d(320),
            nn.ReLU(),
            nn.Conv2d(320, 320, kernel_size=1, stride=1, padding=0, bias=False),
            nn.BatchNorm2d(320),
        ...
        self.filter2 = nn.Sequential(*[
            nn.Conv2d(256, 640, kernel_size=1, stride=1, padding=0, bias=False),
            nn.BatchNorm2d(640),
            nn.ReLU(),
            nn.Conv2d(640, 640, kernel_size=1, stride=1, padding=0, bias=False),
            nn.BatchNorm2d(640),
        ...
        self.filter3 = nn.Sequential(*[
            nn.Conv2d(512, 1280, kernel_size=1, stride=1, padding=0, bias=False),
            nn.BatchNorm2d(1280),
            nn.ReLU(),
...
class BaselineStudent(SystemModel):
    def __init__(self, 
        ...
        self.model = WideResNet(depth=16, widen_factor=8, num_classes=num_classes, temperature=1)
